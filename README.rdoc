...
git clone https://github.com/karancho/Pasantes

2) Instalar Ruby en la rama 2.0, preferentemente con RVM

3) Ejecutar bundle en la raíz del proyecto

4) Escojer algun tipo de base de datos en config/routes.rb
...
Este server permite varias conexiones simultáneas, y debería ser suficiente para una Lan pequeña.
